  ...
  return (
    <>
      ...
      <Section title="TextField (variants)">
        <TextField variant="box" label="Box" placeholder="Enter text" value={text} onChange={(e) => setText(e.target.value)} />
        <TextField variant="line" label="Line" placeholder="Enter text" value={text} onChange={(e) => setText(e.target.value)} />
        <TextField variant="big" label="Big" placeholder="Enter text" value={text} onChange={(e) => setText(e.target.value)} />
      </Section>
